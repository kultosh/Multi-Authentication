			...
			<div class="row" style="background: #48413c; color: #fff;">	
				<div class="col-md-12">
					<nav class="navbar navbar-light">
						<strong class="profile"><a href="{{route('adminDashboard')}}">{{Auth::user()->name}}/a></strong>
						<a class="navbar-brand">Library Management System</a>
						<a href="{{route('Admin_logout')}}" style="text-decoration: none"><button class="btn btn-danger btn-block">Logout</button></a>
					</nav>
				</div>
			</div>	
			<div class="row t">
